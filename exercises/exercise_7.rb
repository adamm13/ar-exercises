...
# @store6.employees.create(first_name: "Q", last_name: "Q", hourly_rate: 10)


puts "Give me a Store Name" #1

new_store = gets.chomp  #1

@store7 = Store.create(name: new_store) #2

puts @store7.errors.full_messages #3
